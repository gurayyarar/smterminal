...
var NetworkDal = /** @class */ (function () {
    function NetworkDal() {
    }
    NetworkDal.prototype.getDataTransferInfosAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, si.networkStats().then(function (data) {
                            var result = {
